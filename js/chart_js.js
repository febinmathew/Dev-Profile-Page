...
//   var label3 =moment.duration(dataTime3.diff(now)).humanize(true);
  ...
  var config = {
    ...
    data: {
      labels: [
        "NodeJs", "Angular 7","ExpressJs","javascript","PostgreSQL", "Firebase","Flutter", "Java" ],
      datasets: [
    //       {
    //     label: label1,
    ...
    options: {
      legend: {
        position: 'top',
        display: false //to remove the label
      },
    //   title: {
    //     display: true,
      ...
      tooltips:{
        ...
        callbacks:{
          label: function(tooltipItem, data){
            ...
            return datasetLabel + ': '+ data.datasets[tooltipItem.datasetIndex].notes[tooltipItem.index];
          }
        },
